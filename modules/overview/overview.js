...
export function mountOverview(root){
  ...
  if(!rows || rows.length === 0){
    root.appendChild(sectionCard({ title:"Overzicht", subtitle:"Upload eerst een Excel-bestand in het hoofdmenu.", children:[
  ...
  root.appendChild(sectionCard({ title:"Overzicht", subtitle:"Snelle dataset-samenvatting.", children:[
